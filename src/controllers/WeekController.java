...
public class WeekController {
	...
	Event event = new Event(1, "M�te",null, null, LocalDateTime.now(), LocalDateTime.now().plusHours(2) , cal);
	Event event2 = new Event(2, "Annet M�te",null, null, LocalDateTime.now().plusMinutes(15)
